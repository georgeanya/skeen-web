...
const Section4 = () => {
  return (
    <div className="px-5 md:px-[125px] pb-[90px] md:pb-[130px] pt-20 md:pt-0 flex flex-col md:flex-row md:justify-between md:gap-[106px] bg-[#1B947D]">
      <div className="md:max-w-[549px] pb-[60px] md:pb-0 md:pt-[184px]">
        ...
        Support your custom cream with routine essentials
        </p>
        ...
        <div className="mt-8 ">
          <Link href="https://paystack.shop/skeen">

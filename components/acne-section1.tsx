...
const Section1 = () => {
  const [faqs, setFaqs] = useState([
    {
      question: "How do I use my Acne Cream?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Many patients using the Acne Cream see noticeable results within 6 to 12 weeks with consistent use. However, everyone's skin is unique, so your timeline may differ.",
      open: false,
    },

    {
      question: "How long will my Acne Cream last?",
      answer: "One bottle contains approximately a 2-month supply.",
      open: false,
    },
    {
      question: "Can I use other products with my Acne Cream?",
      answer:
        "Yes, you can, but since the Acne Cream contains clinical-strength actives, we recommend simplifying your routine to gentle cleansing and moisturizing in conjunction with your cream. Your dermatology provider will provide more information about incorporating your cream into your skincare routine.",
      open: false,
    },
    {
      question: "What type of skin does the Acne Cream work for?",
      answer:
        "The Acne Cream can be used by all skin types (dry, combination, and oily). Your dermatology provider will use the information you provide to formulate one that works for you.",
      open: false,
    },
  ]);

  ...
  return (
    <div className="px-5 md:px-[125px] pb-[90px] md:pb-[130px] grid md:grid-cols-2 pt-20 md:pt-[120px] grid-cols-1 md:grid-rows-1 md:gap-[89px] gap-4 bg-[#F5F5F5]">
      <div className=" pb-[35px] md:pb-0 ">
        <p className="  text-[32px] leading-[40px] md:text-start md:text-[46px] font-bold text-[#3E7EEE]  md:leading-[58px] md:min-w-[551px]">
          We are making skincare accessible, personalized, and convenient, the
          way it should be
        </p>
      </div>
      <div className="  text-[#333D47]">
        ...
        <div className="flex justify-between items-center">
          <p className="text-[16px] leading-[22px] md:text-[22px] md:leading-8">
            ...
            and the line at your local skincare shop. Access treatment online at
            your convenience
          </p>
        </div>
      </div>

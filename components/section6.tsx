...
const Section1 = () => {
  return (
    <div className="px-5 md:px-32 md:pt-28 pt-20 md:pb-28 pb-20 bg-[#487FE6] text-white ">
      ...
      <div className="grid md:grid-cols-3 grid-cols-1 md:grid-rows-1 gap-6 mt-12">
        ...
        <div className="md:px-10 md:py-12 px-5 py-8 bg-white">
          <p className="text-[18px] leading-[26px] md:text-[22px] md:leading-[34px] text-[#333D47]">
            I was experiencing a skin rash and didn&apos;t know what it was. Skeen
            connected me with a dermatologist who diagnosed it as eczema and
        ...
        <div className="md:px-10 md:py-12 px-5 py-8 bg-white">
          <p className="text-[18px] leading-[26px] md:text-[22px] md:leading-[34px] text-[#333D47]">
            I live in Ogoja and don&apos;t have access to a dermatologist nearby.
            Skeen was a lifesaver - I got the care I needed without having to
            travel hours!
          </p>
          <div className="flex justify-between items-center mt-6">
            <p className="md:text-[20px] md:leading-[30px] text-[16px] leading-[22px] text-[#6C7884] ">
